...
- **Data Science Intern**<br>Company: [Federal Express Corporation](https://www.fedex.com/en-us/home.html)<br>I Designed a multi-factor risk-scoring **AI Agent** engine in Python, weighting 4 risk dimensions (guard cost, repair cost, duration, compliance) across 3 facility types to replace static FIFO queuing, which reduce annual guard cost from $14M to $12M and cutting average time-to-action by 27%. Plus, I applied a greedy best-first algorithm to auto-generate prioritized action plans across 2 ranking modes, and building a **RAG-powered Claude API assistant** via **Databricks** and **Azure** using **LangChain** for natural-language querying. I plan to ship it as a monthly automated pipeline that cut untracked non-compliance cases from 73% to 24% of facilities. <br>
<br> I owned end-to-end development of **Python** models to predict package loss for FedEx Europe, integrating 8,000+ annual customer claims with thousands of daily scan and miss committed records to surface loss patterns across the shipment journey. And I wrote **SQL** via SSMS to extract scan data for large-scale processing <br>
